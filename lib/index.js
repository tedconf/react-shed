...
var sizes = function sizes() {
  ...
  return Array.from([].concat(Array(number))).reduce(function (acc, curr, i) {
    ...
    return (0, _extends5.default)({}, acc, (_extends2 = {}, _extends2['z' + i] = (0, _modularscale2.default)(i - 1, scale) + 'rem', _extends2.z0 = 0, _extends2['z.' + (number - i)] = (0, _modularscale2.default)(-1 - i, scale) + 'rem', _extends2));
  }, {});
};
