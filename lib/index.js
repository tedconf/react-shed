...
var getPropsForColor = function getPropsForColor(value, theme) {
  if (isValid('color')(value)) {
    ...
    if (alpha) {
      var transparentColor = _colorString2.default.getRgba(theme.colors['' + alpha[1]]);
      transparentColor[3] = alpha[2];
      return _colorString2.default.rgbaString(transparentColor);
    }
...
var Shed = function Shed(_ref) {
  ...
  var ShedStyled = (0, _glamorous2.default)(component)(function (props, theme) {
    return (0, _extends5.default)({}, getPropForProps(props, theme));
  });
  return _react2.default.createElement(ShedStyled, rest);
};
