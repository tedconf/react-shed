...
exports.createTheme = exports.defaultTheme = undefined;
...
var createTheme = function createTheme() {
  ...
  if (userSizes && (typeof userSizes === 'undefined' ? 'undefined' : (0, _typeof3.default)(userSizes)) === 'object') {
    var sizesHash = Object.keys(userSizes).reduce(function (acc, curr, i) {
      var _extends3;

      return (0, _extends5.default)({}, acc, (_extends3 = {}, _extends3['z' + curr] = userSizes[curr], _extends3));
    }, {});
    if (!sizesHash['z0']) {
      sizesHash['z0'] = 0;
    }
  ...
  if (fonts && (typeof fonts === 'undefined' ? 'undefined' : (0, _typeof3.default)(fonts)) === 'object') {
  ...
  if (colors && (typeof colors === 'undefined' ? 'undefined' : (0, _typeof3.default)(colors)) === 'object') {
...
var Shed = function Shed(_ref) {
  ...
  var ShedStyled = (0, _styledComponents2.default)(component)(_templateObject, function (_ref2) {
