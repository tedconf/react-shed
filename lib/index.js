...
exports.reset = exports.createTheme = exports.default = undefined;
...
var isValid = _curry2.default.to(2, function (label, val) {
...
var sizes = function sizes() {
  ...
  return Array.from([].concat((0, _toConsumableArray3.default)(Array(number)))).reduce(function (acc, curr, i) {
    var _extends2;

    return (0, _extends5.default)({}, acc, (_extends2 = {}, (0, _defineProperty3.default)(_extends2, 'z' + i, (0, _modularscale2.default)(i - 1, scale) + 'rem'), (0, _defineProperty3.default)(_extends2, 'z0', 0), (0, _defineProperty3.default)(_extends2, 'z.' + (number - i), (0, _modularscale2.default)(i - number, scale) + 'rem'), (0, _defineProperty3.default)(_extends2, 'z-' + i, '-' + (0, _modularscale2.default)(i - 1, scale) + 'rem'), (0, _defineProperty3.default)(_extends2, 'z0', 0), (0, _defineProperty3.default)(_extends2, 'z.-' + (number - i), '-' + (0, _modularscale2.default)(i - number, scale) + 'rem'), _extends2));
  }, {});
};

var reset = (0, _styledComponents.injectGlobal)(_templateObject);
...
var createTheme = function createTheme() {
  ...
  if (userTheme.sizes && (0, _typeof3.default)(userTheme.sizes) === 'object') {
    var sizesHash = Object.keys(userTheme.sizes).reduce(function (acc, curr, i) {
      return (0, _extends5.default)({}, acc, (0, _defineProperty3.default)({}, 'z' + curr, userTheme.sizes[curr]));
    }, {});
    if (!sizesHash['z0']) {
      sizesHash['z0'] = 0;
    }
...
var Shed = function Shed(_ref) {
  ...
  var ShedStyled = (0, _styledComponents2.default)(component).withConfig({
  ...
  return _react2.default.createElement(ShedStyled, props);
};
