...
exports.createTheme = exports.default = undefined;
...
var isValid = (0, _curry2.default)(function (label, val) {
  if (!val) {
    return false;
  }
  ...
  if (typeof val !== 'string') {
    if (typeof val !== 'number') {
      throw new Error('You must provide a valid value for the ' + label + ' prop: A number or string, not ' + JSON.stringify(val) + ' (' + (typeof val === 'undefined' ? 'undefined' : (0, _typeof3.default)(val)) + ')');
    }
  }
...
var sizes = function sizes() {
  ...
  return Array.from([].concat(Array(number))).reduce(function (acc, curr, i) {
    ...
    return (0, _extends5.default)({}, acc, (_extends2 = {}, _extends2['z' + i] = (0, _modularscale2.default)(i - 1, scale) + 'rem', _extends2['z.' + (number - i)] = (0, _modularscale2.default)(i - number, scale) + 'rem', _extends2.z0 = 0, _extends2['z-' + i] = '-' + (0, _modularscale2.default)(i - 1, scale) + 'rem', _extends2['z-.' + (number - i)] = '-' + (0, _modularscale2.default)(i - number, scale) + 'rem', _extends2));
  }, {});
};
...
var createTheme = function createTheme() {
  ...
  if (userTheme.sizes && (0, _typeof3.default)(userTheme.sizes) === 'object') {
    var sizesHash = Object.keys(userTheme.sizes).reduce(function (acc, curr) {
      var _extends3;

      return (0, _extends5.default)({}, acc, (_extends3 = {}, _extends3['z' + curr] = userTheme.sizes[curr], _extends3));
    }, {});
    if (!sizesHash.z0) {
      sizesHash.z0 = 0;
    }
  ...
  if (userTheme.fonts && (0, _typeof3.default)(userTheme.fonts) === 'object') {
  ...
  if (userTheme.colors && (0, _typeof3.default)(userTheme.colors) === 'object') {
  ...
  return (0, _extends5.default)({}, userTheme, generatedTheme);
};
      ...
      default:
        {
          ...
          var sizeScale = (0, _get2.default)('sizes')(theme);
...
var getPropsForColor = function getPropsForColor(value, theme) {
  if (isValid('color')(value)) {
    ...
    if (alpha) {
      return (0, _color2.default)(theme.colors['' + alpha[1]]).alpha(alpha[2]).string();
    }
  ...
  if (props) {
    Object.keys(props).forEach(function (prop) {
      if (['m', 'mx', 'my', 'mt', 'mr', 'mb', 'ml', 'p', 'px', 'py', 'pt', 'pr', 'pb', 'pl'].indexOf(prop) > -1) {
        newProps = (0, _extends5.default)({}, newProps, getPropsForMPValue(prop, props[prop], theme));
      }
    });
  }
  return newProps;
  ...
  if (props) {
    Object.keys(props).forEach(function (prop) {
      if (['br', 'brx', 'bry', 'brt', 'brr', 'brb', 'brl', 'brtr', 'brtl', 'brbr', 'brbl'].indexOf(prop) > -1) {
        newProps = (0, _extends5.default)({}, newProps, getPropsForBRValue(prop, props[prop], theme));
      }
    });
  }
  return newProps;
  ...
  return Object.keys(props).reduce(function (acc) {
    if (props) {
      var getProp = function getProp(prop) {
        return (0, _get2.default)(prop)(props);
      };
      return (0, _extends5.default)({}, acc, getMarginAndPadding(props, theme), {
        ...
        fontFamily: orNull((0, _get2.default)('fonts.' + getProp('ff'))(theme)),
...
var removeProps = function removeProps(oldProps) {
  return (0, _omit2.default)(REJECTED_KEYS, oldProps);
};
...
var Shed = function Shed(_ref) {
  var _ref$component = _ref.component,
      ...
      props = (0, _objectWithoutProperties3.default)(_ref, ['component', 'theme']);

  var ShedStyled = (0, _react4.default)(component, [getPropForProps(props, theme)], []);
  return _react2.default.createElement(ShedStyled, removeProps(props));
};
...
Shed.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  theme: _propTypes2.default.shape({
    sizes: _propTypes2.default.oneOf([_propTypes2.default.string, _propTypes2.default.object]),
    steps: _propTypes2.default.number,
    colors: _propTypes2.default.object,
    fonts: _propTypes2.default.object
  })
} : {};
...
var ThemedShed = (0, _theming.withTheme)(Shed);

exports.default = ThemedShed;
