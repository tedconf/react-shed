...
var func$2 = convert_1('get', get_1);
...
function isNumber(value) {
  return typeof value == 'number' ||
    (isObjectLike$2(value) && objectToString$2.call(value) == numberTag$4);
}

var index$12 = isNumber;
...
var sizes = function sizes() {
  ...
  return Array.from([].concat(toConsumableArray(Array(number)))).reduce(function (acc, curr, i) {
    var _babelHelpers$extends;

    return _extends({}, acc, (_babelHelpers$extends = {}, defineProperty$2(_babelHelpers$extends, 'z' + i, index$11(i - 1, scale) + 'rem'), defineProperty$2(_babelHelpers$extends, 'z.' + (number - i), index$11(i - number, scale) + 'rem'), defineProperty$2(_babelHelpers$extends, 'z0', 0), defineProperty$2(_babelHelpers$extends, 'z-' + i, '-' + index$11(i - 1, scale) + 'rem'), defineProperty$2(_babelHelpers$extends, 'z-.' + (number - i), '-' + index$11(i - number, scale) + 'rem'), _babelHelpers$extends));
  }, {});
};
...
var createTheme = function createTheme() {
  ...
  if (userTheme.sizes && _typeof(userTheme.sizes) === 'object') {
    var sizesHash = Object.keys(userTheme.sizes).reduce(function (acc, curr) {
      return _extends({}, acc, defineProperty$2({}, 'z' + curr, userTheme.sizes[curr]));
    }, {});
    if (!sizesHash.z0) {
      sizesHash.z0 = 0;
    }
      ...
      default:
        {
          ...
          var sizeScale = get$1('sizes')(theme);
...
var getPropsForColor = function getPropsForColor(value, theme) {
  if (isValid('color')(value)) {
    ...
    if (alpha) {
      return index(theme.colors['' + alpha[1]]).alpha(alpha[2]).string();
    }
  ...
  return Object.keys(props).reduce(function (acc) {
    if (props) {
      ...
      return _extends({}, acc, getMarginAndPadding(props, theme), {
        ...
        fontFamily: orNull(get$1('fonts.' + getProp('ff'))(theme)),
...
export { createTheme };export default Shed;
//# sourceMappingURL=react-shed.es.js.map
