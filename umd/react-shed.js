...
var baseSetData = __webpack_require__(85),
    createBind = __webpack_require__(190),
    createCurry = __webpack_require__(191),
    createHybrid = __webpack_require__(90),
    createPartial = __webpack_require__(210),
    getData = __webpack_require__(94),
    mergeData = __webpack_require__(211),
...
var composeArgs = __webpack_require__(91),
    composeArgsRight = __webpack_require__(92),
    countHolders = __webpack_require__(192),
    createCtor = __webpack_require__(24),
    createRecurry = __webpack_require__(93),
    getHolder = __webpack_require__(101),
    reorder = __webpack_require__(209),
...
var getWrapDetails = __webpack_require__(199),
    insertWrapDetails = __webpack_require__(200),
...
var Stack = __webpack_require__(61),
    ...
    initCloneArray = __webpack_require__(255),
    initCloneByTag = __webpack_require__(256),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_extends__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_extends___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_extends__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_typeof__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_typeof___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_typeof__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_react__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_omit__ = __webpack_require__(172);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_omit___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_omit__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_prop_types__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_color__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_color___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_color__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_curry__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_curry___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_curry__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_lodash_fp_get__ = __webpack_require__(177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_lodash_fp_get___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_lodash_fp_get__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_modularscale__ = __webpack_require__(297);
...
var isValid = __WEBPACK_IMPORTED_MODULE_7_curry___default()(function (label, val) {
  if (!val) {
    return false;
  }
  ...
  if (typeof val !== 'string') {
    if (typeof val !== 'number') {
      throw new Error('You must provide a valid value for the ' + label + ' prop: A number or string, not ' + JSON.stringify(val) + ' (' + (typeof val === 'undefined' ? 'undefined' : __WEBPACK_IMPORTED_MODULE_2__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_typeof___default()(val)) + ')');
    }
  }
...
var sizes = function sizes() {
  ...
  return Array.from([].concat(Array(number))).reduce(function (acc, curr, i) {
    ...
    return __WEBPACK_IMPORTED_MODULE_1__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_extends___default()({}, acc, (_extends2 = {}, _extends2['z' + i] = __WEBPACK_IMPORTED_MODULE_9_modularscale___default()(i - 1, scale) + 'rem', _extends2['z.' + (number - i)] = __WEBPACK_IMPORTED_MODULE_9_modularscale___default()(i - number, scale) + 'rem', _extends2.z0 = 0, _extends2['z-' + i] = '-' + __WEBPACK_IMPORTED_MODULE_9_modularscale___default()(i - 1, scale) + 'rem', _extends2['z-.' + (number - i)] = '-' + __WEBPACK_IMPORTED_MODULE_9_modularscale___default()(i - number, scale) + 'rem', _extends2));
  }, {});
};
...
var createTheme = function createTheme() {
  ...
  if (userTheme.sizes && __WEBPACK_IMPORTED_MODULE_2__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_typeof___default()(userTheme.sizes) === 'object') {
    var sizesHash = Object.keys(userTheme.sizes).reduce(function (acc, curr) {
      var _extends3;

      return __WEBPACK_IMPORTED_MODULE_1__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_extends___default()({}, acc, (_extends3 = {}, _extends3['z' + curr] = userTheme.sizes[curr], _extends3));
    }, {});
    if (!sizesHash.z0) {
      sizesHash.z0 = 0;
    }
  ...
  if (userTheme.fonts && __WEBPACK_IMPORTED_MODULE_2__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_typeof___default()(userTheme.fonts) === 'object') {
  ...
  if (userTheme.colors && __WEBPACK_IMPORTED_MODULE_2__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_typeof___default()(userTheme.colors) === 'object') {
      ...
      default:
        {
          ...
          var sizeScale = __WEBPACK_IMPORTED_MODULE_8_lodash_fp_get___default()('sizes')(theme);
...
var getPropsForColor = function getPropsForColor(value, theme) {
  if (isValid('color')(value)) {
    ...
    if (alpha) {
      return __WEBPACK_IMPORTED_MODULE_6_color___default()(theme.colors['' + alpha[1]]).alpha(alpha[2]).string();
    }
  ...
  if (props) {
    Object.keys(props).forEach(function (prop) {
      if (['m', 'mx', 'my', 'mt', 'mr', 'mb', 'ml', 'p', 'px', 'py', 'pt', 'pr', 'pb', 'pl'].indexOf(prop) > -1) {
        newProps = __WEBPACK_IMPORTED_MODULE_1__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_extends___default()({}, newProps, getPropsForMPValue(prop, props[prop], theme));
      }
    });
  }
  return newProps;
  ...
  if (props) {
    Object.keys(props).forEach(function (prop) {
      if (['br', 'brx', 'bry', 'brt', 'brr', 'brb', 'brl', 'brtr', 'brtl', 'brbr', 'brbl'].indexOf(prop) > -1) {
        newProps = __WEBPACK_IMPORTED_MODULE_1__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_extends___default()({}, newProps, getPropsForBRValue(prop, props[prop], theme));
      }
    });
  }
  return newProps;
  ...
  return Object.keys(props).reduce(function (acc) {
    if (props) {
      var getProp = function getProp(prop) {
        return __WEBPACK_IMPORTED_MODULE_8_lodash_fp_get___default()(prop)(props);
      };
      return __WEBPACK_IMPORTED_MODULE_1__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_extends___default()({}, acc, getMarginAndPadding(props, theme), {
        ...
        fontFamily: orNull(__WEBPACK_IMPORTED_MODULE_8_lodash_fp_get___default()('fonts.' + getProp('ff'))(theme)),
...
var removeProps = function removeProps(oldProps) {
  return __WEBPACK_IMPORTED_MODULE_4_omit___default()(REJECTED_KEYS, oldProps);
};
...
var Shed = function Shed(_ref) {
  var _ref$component = _ref.component,
      ...
      props = __WEBPACK_IMPORTED_MODULE_0__Users_vincentspeelman_Projects_shed_react_shed_node_modules_nwb_node_modules_babel_runtime_helpers_objectWithoutProperties___default()(_ref, ['component', 'theme']);

  var ShedStyled = __WEBPACK_IMPORTED_MODULE_10_emotion_react___default()(component, [getPropForProps(props, theme)], []);
  return __WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement(ShedStyled, removeProps(props));
};
...
var convert = __webpack_require__(178),
    func = convert('get', __webpack_require__(127));
...
var baseConvert = __webpack_require__(179),
...
var mapping = __webpack_require__(180),
...
var createWrap = __webpack_require__(46);
...
var LazyWrapper = __webpack_require__(50),
    ...
    isArray = __webpack_require__(1),
    isObjectLike = __webpack_require__(12),
    wrapperClone = __webpack_require__(198);
...
var createWrap = __webpack_require__(46),
    flatRest = __webpack_require__(291);
...
(function() {
  ...
  isNumber = __webpack_require__(298);
...
var _hash = __webpack_require__(303);
